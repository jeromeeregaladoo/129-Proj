...
public class SearchPrototype extends javax.swing.JPanel {
    ...
    private void addToPanel(ArrayList<Object> list, javax.swing.JPanel panel){
        for (Object item :list)
        {
            //panel.add(new LotRow(item));          //currently in need of fixing, will use a presenter type object next.
        }
    }
}
