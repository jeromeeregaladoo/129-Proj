...
public class LotUI extends javax.swing.JPanel {
    Lot lot;
    SQLConn c;
    ...
    private void initComponents() {
        ...
        jLabel10.setText(String.valueOf(lot.getSqm()));

        jLabel11.setText("SQM Cost:");

        jLabel12.setText(String.valueOf(lot.getSqmCost()));

        jLabel15.setText("Total Cost:");

        jLabel16.setText(String.valueOf(lot.getTotalCost()));

        jLabel4.setText(lot.getLotCode());

        jLabel2.setText("Code:");

        jLabel1.setText(lot.getLotName());

        jLabel5.setText("Name:");

        jLabel14.setText(lot.getBlockCode());

        jLabel13.setText("Block:");

        jLabel6.setText(lot.getLotDesc());
